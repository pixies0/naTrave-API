...
export const create = async ctx => {
  ...
  // if (ctx.request.body.homeTeamScore) {
  //   data.homeTeamScore = ctx.request.body.homeTeamScore
  // }
  // if (ctx.request.body.awayTeamScore) {
  //   data.awayTeamScore = ctx.request.body.awayTeamScore
  // }
}
